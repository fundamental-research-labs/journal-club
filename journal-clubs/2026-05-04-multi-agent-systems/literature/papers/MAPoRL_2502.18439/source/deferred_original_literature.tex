\section{Detailed Related Work Discussion}
...
In contrast,  \ourstwo~employs (multi-agent) RL to train the whole multi-LLM system. Recently, after \ours was released, \citet{liao2025marft} provided a similar training system of multi-agents with reinforcement learning. 
