\section{Deferred Content of \Cref{sec:theory}}
...
\claimsingle*
\begin{proof}
For the last turn (\( {t} = 2 \)), regardless of whether the opponent selects \( a_0 \) or not, choosing \( a_1 \) is {an} optimal strategy. This is because:
\begin{itemize}
