...
\vspace{-0.15in}
    \begin{center}
    \includegraphics[width=1.\textwidth]{figs/metachainnew-intro-new.pdf}
    \end{center}
    \vspace{-0.15in}
    ...
    \caption{\model\ is a new LLM agent framework that enables fully automated, zero-code development for complex task automation. It features self-evolving agents via self-play customization and a generalist agent stack for Search·Code·Files, unifying tool use and vector-native retrieval for RAG-ready workflows. This language-driven approach democratizes AI development, allowing anyone to create, adapt, and orchestrate agents, tools, and workflows from natural-language instructions.}
    \label{fig:intro}
    % \vspace{-1.0em}
\end{figure*}
