...
| What should an agent stop having to relearn? | C005 supplies the documented error and instruction change; C011 explains future-task value and cost; C012 supplies the proposed check ablation; C009/C021 support the brief learned-adaptation extension. |
