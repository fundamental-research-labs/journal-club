...
- **Support:** C003–C010, with primary links and locators above. Positive matched controls and negative stress tests jointly explain the preferred thesis. The thesis-driven coverage pass adds C013–C019 and 56 source families; these are not independent replications. ReasoningBank and bounded internalization gains qualify a simple learning-versus-compute dichotomy.
...
- **Locators / evidence:** ADAS §§3–4; AFlow §§4–5; DGM §§3–6; HGM §§3–4; AHE v4 Tables 2–3; Evo-Harness §4.5/Table 4; SHAPER §§3–4. AHE held-out success gain is 0.4 pp; token means exclude timeouts.
