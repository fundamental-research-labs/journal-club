...
Revision: September 18, 2026 — narrative rhythm. Existing thesis, C001–C019, source artwork, and September 16 research cutoff preserved.

## Narrative and visual direction

22 main slides + 9 appendices; approximately 25–30 minutes plus discussion. Introduction (1–4) motivates the topic, defines the change mechanisms, and ends with the main question. Results have three parts: useful procedures (5–9), durability (10–13), and improving the improver (14–18). Each begins with a motivating question before evidence. Conclusion (19–22) answers the main question, summarizes evidence limits, and opens discussion. Detailed proposed controls are available in the appendix.

Retain the forest-green/ivory palette, Georgia headlines, offline fonts, original source figures, and Robert Yang / Fundamental Research Labs attribution. New question and mini-introduction slides use spacious green-tinted compositions with a large question, motivation, and evidence preview. Evidence pages retain their readable ivory treatment. The final synthesis follows the evidence instead of appearing at the beginning.
...
- Claims: C001, C011
- Sources: Analyst framing/synthesis; claim ledger.
...
## 08 · A strong fixed skill captures much of the gain
- Section / role: RESULTS / USEFUL PROCEDURES / result
...
## 09 · More attempts are a serious competing baseline
- Section / role: RESULTS / USEFUL PROCEDURES / result
...
## 10 · Do the gains survive the next tasks?
...
## 11 · Mixed task streams expose uneven gains
...
## 12 · Repeated learning can deteriorate—or improve
- Section / role: RESULTS / DURABILITY / result
...
## 13 · Production learning combines several loops
- Section / role: RESULTS / DURABILITY / result
...
## 14 · Can the improvement method itself improve?
...
## 15 · Editing an agent and editing its improver differ
...
## 16 · Improvement behavior can transfer to a new domain
- Section / role: RESULTS / IMPROVING THE IMPROVER / result
...
## 17 · The added long-run advantage remains uncertain
- Section / role: RESULTS / IMPROVING THE IMPROVER / result
...
## 18 · Replay can help revise how a system searches
- Section / role: RESULTS / IMPROVING THE IMPROVER / result
...
## 19 · Useful learning is established; sustained compounding is not
...
## 20 · Test the next task, the old task, and the bill
...
## 21 · Which result would change your mind?
...
## 22 · Make experience valuable beyond its original task
...
## 23 · Appendix · compare four practical alternatives fairly
...
## 24 · Appendix · separate what it knows from what it can learn next
- Section / role: APPENDIX / appendix
...
## 25 · Appendix · a model can learn to write update data
- Section / role: APPENDIX / appendix
...
## 26 · Appendix · read each number with its denominator
- Section / role: APPENDIX / appendix
...
## 27 · Appendix · one-shot authoring is a different test
- Section / role: APPENDIX / appendix
...
## 28 · Appendix · primary sources 1/4
- Section / role: APPENDIX / appendix
...
## 29 · Appendix · primary sources 2/4
- Section / role: APPENDIX / appendix
- Purpose: Provide stable primary links and publication status.
- Visual: Spacious source list with short labels and stable URLs.
- Claims: Reference index
...
## 30 · Appendix · primary sources 3/4
- Section / role: APPENDIX / appendix
- Purpose: Provide stable primary links and publication status.
- Visual: Spacious source list with short labels and stable URLs.
- Claims: Reference index
...
## 31 · Appendix · primary sources 4/4
- Section / role: APPENDIX / appendix
- Purpose: Provide stable primary links and publication status.
- Visual: Spacious source list with short labels and stable URLs.
- Claims: Reference index
