...
Key: `2024-automated-design-agentic-systems`. Hu, Shengran, Lu, Cong, Clune, Jeff. [Primary v2](https://arxiv.org/html/2408.08435v2); [register](../sources.md#2024-automated-design-agentic-systems). First 2024-08-15; revision 2025-03-02. Read September 16, 2026: primary methods, results and relevant appendices; coordinator reopened metadata/methods. Results are author-reported; no experiments reproduced.


[Retained original](../originals/2024-automated-design-agentic-systems/2024-automated-design-agentic-systems-paper-v2.pdf); CC BY 4.0.
